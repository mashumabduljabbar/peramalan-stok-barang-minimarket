...
<tr>
	<td style="text-align:center; padding:4px; margin:4px; font-weight:bold; font-size: 14pt;">
...
<?php
  ...
  if(strpos($geturl1, "analisis")!== FALSE){
	  $analisis = "active";
  }
?>
                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
							...
							<a class="nav-link <?php echo $stok;?>" href="<?php echo base_url(); ?>stok"
                                ...
                                Data Stok Barang</a>
							<a class="nav-link <?php echo $analisis;?>" href="<?php echo base_url(); ?>analisis"
